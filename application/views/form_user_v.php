...
if (isset($user)) {
 	foreach ($user as $row) {
 		...
 		$level=$row->level;
 		$action="http://localhost/talita-booking/index.php/user/save_edit";
 	}
 } 
 else {
 	$id="";
 	...
 	$fullname="";
 	$level="";
 	$action="http://localhost/talita-booking/index.php/user/add";
 }
 	?>
...
<table>
	...
	<tr><td>Username</td><td> : </td><td><input name="username" value="<?php echo $username;?>"></td></tr>
	<tr><td>Password</td><td> : </td><td><input name="password" type="password" value="<?php echo $password;?>"></td></tr>
	<tr><td>Fullname</td><td> : </td><td><input name="fullname" value="<?php echo $fullname;?>"></td></tr>
